...
def test_build_user_message_lists_frontmatter_then_body():
    ...
    out = tuiguan.build_user_message(msg, Decision(action="judge", tier="tier_b", reasons=["tier=tier_b → action=judge"]))
...
def test_build_user_message_renders_attaches():
    ...
    out = tuiguan.build_user_message(msg, Decision(action="judge", tier="tier_b", reasons=[]))
